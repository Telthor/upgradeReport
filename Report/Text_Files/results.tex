...
Measurements of the Stark shift was undertaken at the maximum voltage before relaxation behaviour occurred of 15V (40V/mm), using the pulse sequence shown in figure \ref{fig:nuclearecho}.
...
The small change in the signal relative to the slight reduction in $T_1$ of the electron increasing the signal by relaxing electrons previously saturated by the repetition rate of the experiment to thermal equilibrium. 
